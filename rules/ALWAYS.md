...
- **ai-chat-response-discipline** → `~/.ai-context/rules/ai-chat-response-discipline.md` — Enforces strict response boundaries — no unsolicited code, no file changes without approval, no scope creep, no token waste. Every response must be surgically scoped to the user's exact request.
...
<!-- @include: rules/ai-chat-response-discipline.md -->
